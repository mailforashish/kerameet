...
public class ProfilePagerAdapterViewProfile extends RecyclerView.Adapter<ProfilePagerAdapterViewProfile.ViewHolder> {

    List<FemaleImage> list;
    Context context;
    boolean canOpen;

    public ProfilePagerAdapterViewProfile(Context context, List<FemaleImage> list, boolean canOpen) {
        ...
        public ViewHolder(View view) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (canOpen) {
                       // new PictureViewOnViewProfile(context, list, getAdapterPosition());
                    }
                }
            });
        }
