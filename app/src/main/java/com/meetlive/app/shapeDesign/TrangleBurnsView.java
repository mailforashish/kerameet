...
public class TrangleBurnsView extends ImageView {
    ...
    /** A {@link TrangleBurnsView.TransitionListener} to be notified when
     *  a transition starts or ends. */
    private TrangleBurnsView.TransitionListener mTransitionListener;
    ...
    public TrangleBurnsView(Context context) {
        this(context, null);
    }


    public TrangleBurnsView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public TrangleBurnsView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setTransitionListener(TrangleBurnsView.TransitionListener transitionListener) {
