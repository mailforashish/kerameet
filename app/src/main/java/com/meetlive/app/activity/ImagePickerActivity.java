...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        //hide bottom ui here for only crop that
        options.setHideBottomControls(true);
        //set toolbar text color and check &close color here
        options.setToolbarWidgetColor(this.getResources().getColor(R.color.white));
        if (lockAspectRatio)
